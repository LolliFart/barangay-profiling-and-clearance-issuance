...
$since_year = $data['year_of_residency'];
...
<body style="margin:0; background-image: url(image/bg.jpg); background-image-resize:6;">
    ...
    <div style="padding-left:30px; display:float; float:right;">
            <div style="text-align:center; font-size:13px;">
                ...
                <h1 style="text-decoration:underline;">CERTIFICATE OF RESIDENCY</h1>
            </div>
            ...
            <div style="text-align: justify; text-justify: inter-word; font-size:14px;">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <b
                    ...
                    ' years old,
                    ' . $status . ', and a resident of ' . $address . ',
                    since ' . $since_year . ' up to the present as shown in the Sitio Clearance submitted to this office.
                </p>
            ...
            <p>
                ...
                style="font-size:18px; text-decoration:underline;"> ' . $purpose . '</b> and
