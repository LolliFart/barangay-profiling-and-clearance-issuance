    ...
    <div class="col-lg-8 m-auto bg-white p-4" style="border: solid;">
        ...
        <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label for="year_of_residency"><b>Year of residency:</b></label>
                    <input type="text" maxlength="4" minlength="4" name="year_of_residency" class="form-control"
                        value="<?= isset($_POST['year_of_residency']) ? sanitize($_POST['year_of_residency']) : ''; ?>" required>
                    <small class='text-danger'><?= $errors['year_of_residency'] ?? '' ?></small>
                </div>
            </div>
